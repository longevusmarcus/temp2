 ...
 */
export declare function customerPortalOrdersGet(client: PolarCore, security: CustomerPortalOrdersGetSecurity, request: CustomerPortalOrdersGetRequest, options?: RequestOptions): APIPromise<Result<CustomerOrder, ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
