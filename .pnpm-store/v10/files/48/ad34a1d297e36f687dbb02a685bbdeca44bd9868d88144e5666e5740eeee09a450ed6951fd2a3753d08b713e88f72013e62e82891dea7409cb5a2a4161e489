 ...
 */
export declare function checkoutLinksGet(client: PolarCore, request: CheckoutLinksGetRequest, options?: RequestOptions): APIPromise<Result<CheckoutLink, ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
