 ...
 */
export declare function organizationsUpdate(client: PolarCore, request: OrganizationsUpdateRequest, options?: RequestOptions): APIPromise<Result<Organization, NotPermitted | ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
