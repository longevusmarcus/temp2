 ...
 */
export declare function customFieldsUpdate(client: PolarCore, request: CustomFieldsUpdateRequest, options?: RequestOptions): APIPromise<Result<CustomField, ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
