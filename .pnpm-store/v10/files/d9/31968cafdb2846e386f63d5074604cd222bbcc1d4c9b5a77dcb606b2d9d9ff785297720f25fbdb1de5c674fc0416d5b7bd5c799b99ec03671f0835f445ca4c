 ...
 */
export declare function organizationsGet(client: PolarCore, request: OrganizationsGetRequest, options?: RequestOptions): APIPromise<Result<Organization, ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
