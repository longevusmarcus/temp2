 ...
 */
export declare function productsUpdateBenefits(client: PolarCore, request: ProductsUpdateBenefitsRequest, options?: RequestOptions): APIPromise<Result<Product, NotPermitted | ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
