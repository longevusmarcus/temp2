 ...
 */
export declare function checkoutsUpdate(client: PolarCore, request: CheckoutsUpdateRequest, options?: RequestOptions): APIPromise<Result<Checkout, CheckoutForbiddenError | ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
