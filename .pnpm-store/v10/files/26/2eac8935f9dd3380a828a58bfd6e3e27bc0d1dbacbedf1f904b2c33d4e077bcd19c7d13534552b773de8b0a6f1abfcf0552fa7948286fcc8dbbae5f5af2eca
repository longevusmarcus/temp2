 ...
 */
export declare function customFieldsGet(client: PolarCore, request: CustomFieldsGetRequest, options?: RequestOptions): APIPromise<Result<CustomField, ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
