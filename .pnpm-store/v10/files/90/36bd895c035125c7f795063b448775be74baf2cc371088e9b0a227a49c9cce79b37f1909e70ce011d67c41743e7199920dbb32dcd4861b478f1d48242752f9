 ...
 */
export declare function customersUpdateExternal(client: PolarCore, request: CustomersUpdateExternalRequest, options?: RequestOptions): APIPromise<Result<Customer, ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
