 ...
 */
export declare function checkoutsList(client: PolarCore, request: CheckoutsListRequest, options?: RequestOptions): APIPromise<PageIterator<Result<CheckoutsListResponse, HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>, {
    page: number;
}>>;
