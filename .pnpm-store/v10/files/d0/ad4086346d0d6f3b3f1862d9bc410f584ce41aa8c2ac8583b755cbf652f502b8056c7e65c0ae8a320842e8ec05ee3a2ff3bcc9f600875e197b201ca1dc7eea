 ...
 */
export declare function customerPortalBenefitGrantsUpdate(client: PolarCore, security: CustomerPortalBenefitGrantsUpdateSecurity, request: CustomerPortalBenefitGrantsUpdateRequest, options?: RequestOptions): APIPromise<Result<CustomerBenefitGrant, NotPermitted | ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
