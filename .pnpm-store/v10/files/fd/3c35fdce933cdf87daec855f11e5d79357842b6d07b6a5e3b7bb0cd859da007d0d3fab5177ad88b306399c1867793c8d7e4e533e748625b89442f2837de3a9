 ...
 */
export declare function customFieldsDelete(client: PolarCore, request: CustomFieldsDeleteRequest, options?: RequestOptions): APIPromise<Result<void, ResourceNotFound | HTTPValidationError | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
