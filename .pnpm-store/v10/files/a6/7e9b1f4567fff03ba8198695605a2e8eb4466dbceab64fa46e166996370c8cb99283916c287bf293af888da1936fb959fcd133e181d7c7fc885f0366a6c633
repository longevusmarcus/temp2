...
exports.benefitGrantWebhookPropertiesToJSON = benefitGrantWebhookPropertiesToJSON;
exports.benefitGrantWebhookPropertiesFromJSON = benefitGrantWebhookPropertiesFromJSON;
exports.previousPropertiesToJSON = previousPropertiesToJSON;
exports.previousPropertiesFromJSON = previousPropertiesFromJSON;
...
function benefitGrantWebhookPropertiesToJSON(benefitGrantWebhookProperties) {
    return JSON.stringify(exports.BenefitGrantWebhookProperties$outboundSchema.parse(benefitGrantWebhookProperties));
}
function benefitGrantWebhookPropertiesFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.BenefitGrantWebhookProperties$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BenefitGrantWebhookProperties' from JSON`);
}
/** @internal */
...
function previousPropertiesToJSON(previousProperties) {
    return JSON.stringify(exports.PreviousProperties$outboundSchema.parse(previousProperties));
}
function previousPropertiesFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.PreviousProperties$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'PreviousProperties' from JSON`);
}
/** @internal */
