...
async function $do(client, request, options) {
    ...
    const [result, raw] = await M.match(M.json(200, MetersListResponse$inboundSchema, { key: "Result" }), M.jsonErr(422, HTTPValidationError$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
